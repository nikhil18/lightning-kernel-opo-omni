...
#define MIN_INPUT_INTERVAL		120 * 1000L
...
static unsigned int nr_run_thresholds_balance[] = {
	(THREAD_CAPACITY * 675 * MULT_FACTOR) / DIV_FACTOR,
	(THREAD_CAPACITY * 975 * MULT_FACTOR) / DIV_FACTOR,
	(THREAD_CAPACITY * 1275 * MULT_FACTOR) / DIV_FACTOR,
	UINT_MAX
};

static unsigned int nr_run_thresholds_performance[] = {
	(THREAD_CAPACITY * 405 * MULT_FACTOR) / DIV_FACTOR,
	(THREAD_CAPACITY * 675 * MULT_FACTOR) / DIV_FACTOR,
	(THREAD_CAPACITY * 975 * MULT_FACTOR) / DIV_FACTOR,
	UINT_MAX
};
...
static unsigned int nr_run_thresholds_conservative[] = {
	...
	(THREAD_CAPACITY * 1725 * MULT_FACTOR) / DIV_FACTOR,
	(THREAD_CAPACITY * 2325 * MULT_FACTOR) / DIV_FACTOR,
	UINT_MAX
};
